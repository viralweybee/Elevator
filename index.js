...
floor5El_1.addEventListener('click', () => {
    ...
    console.log(index);
    console.log(diff);
    setTimeout(delay, diff * 0.7 * 1000);
    function delay() {
...
floor2El_1.addEventListener('click', () => {
    ...
    console.log(index);
    console.log(diff);
    document.getElementById(`lift${index}`).style.marginTop = '300px';
    document.getElementById(`lift${index}`).style.transition = `${diff * 0.7}s`;
    setTimeout(delay, diff * 0.7 * 1000);
    function delay() {
...
//     let diff=999;
//     for (let i = 0; i < currposition.length; i++) {
//         if(Math.abs(currposition[i]-search)<diff){
//             diff=currposition[i]-search;
//             ind=i+1;
//         }
//     }
//     currposition[ind-1]=search;
// }
// ----------------------------------------------Maintaince--------------------------
